...
import { Bell, Plus, Edit, Trash2, Calendar, Clock, AlertCircle, X } from 'lucide-react';
              ...
              <form onSubmit={handleSubmit} className="space-y-4 ">
                ...
                <div className="flex justify-end gap-2">
                  <button
                    ...
                    className="px-4 py-2 bg-white dark:bg-neutral-700 rounded-xl hover:bg-neutral-200 transition-all duration-200"
                  >
                    Cancelar
                  </button>
                  <button
                ...
                className={`p-4 rounded-2xl border transition-all duration-200 ${
                  reminder.ativo 
                    ? isOverdue(reminder.data_vencimento)
                      ? 'bg-white dark:bg-neutral-700 border-red-200'
                      : 'bg-white dark:bg-neutral-700 border-neutral-200 hover:shadow-medium'
                    : 'bg-white dark:bg-neutral-700 border-neutral-200 opacity-60'
                }`}
              >
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      <h4 className="font-semibold">{reminder.titulo}</h4>
